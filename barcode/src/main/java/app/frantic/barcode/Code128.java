...
public class Code128 {
	...
	public Bitmap getBitmap( int width, int height, int red, int green, int blue) {
		byte[] code = encode();
		if(code == null) {
			return null;
		}
	...
	public Bitmap getBitmap( int width, int height,String colorcode) {
		byte[] code = encode();
		if(code == null) {
			return null;
		}
		...
		bgPaint.setColor(Color.rgb(255, 255, 255));
		bgPaint.setColor(Color.parseColor(colorcode));
